 ...
 @what - This repository started as fork of "freebsd-doc" as this had broken IRIX man page handling
       The initial expectation was to just to some "tweeks" of the FreeBSD Manual pages code
       ...
       The result is that none of the freebsd code was used and instead a much simpler set of
        ...
        I belive that having status pre-rendered ppages make sense for:
          - security - as just server static pages is more secure than calling CGI or other code
